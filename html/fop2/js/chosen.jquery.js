...
(function() {
      ...
      if (option.nodeName.toUpperCase() === "OPTION") {
        if (option.text !== "") {
          ...
          this.parsed.push({
            ...
            color_option: (option.getAttribute("data-color-option") != '' ? option.getAttribute("data-color-option") : '')
          });
        } else {
          this.parsed.push({
            array_index: this.parsed.length,
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.result_add_option = function(option) {
      ...
      option_el.style.borderLeft = '24px solid '+option.color_option; // SET BORDER LEFT OF li WITH SAME HEIGHT
      option_el.setAttribute("data-color-option", option.color_option); // SET data WITH THE OPTION COLOR
  ...
  Chosen = (function(superClass) {
    ...
    Chosen.prototype.choice_build = function(item) {
      ...
      // INSERT A styled DIV INTO EACH .serach-choice ITEM ## ONLY IF data-color-options IS NOT empty OR null
      if(item.color_option !== '' && item.color_option !== null){
        var color_container = $('<div />').css(
          {
            height:19,
            width:10,
            background:item.color_option,
            float:'left',
            margin:'0 3px 0 0'
          }
        );
      }
      choice.prepend(color_container);
