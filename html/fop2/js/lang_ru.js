...
lang['barge'] = 'Вмешиваться в разговор';
...
lang['Identification'] = 'Удостоверение личности';
lang['Categories'] = 'Категории';
lang['Contact'] = 'Контакт';
lang['Notes'] = 'Заметки';
lang['newcontact'] = 'Новый контакт';
lang['Note'] = 'Примечание';
...
lang['Set Tag'] = 'Установить тег';
lang['Select one option'] = 'Выберите один вариант';
lang['Select group to start conversation'] = 'Выберите группу, чтобы начать разговор';

lang['datahasbeensaved'] = 'Данные были сохранены';
lang['%d secs.'] = '%d c.';
