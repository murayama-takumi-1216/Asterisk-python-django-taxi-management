...
$(document).ready(function () {
  ...
  const arrayOcultarColumaTurnoConductorDatatable = [0, 1];
    ...
    columns: [
      ...
      },
      {
        ...
        data: function (data) {
          ...
          let htmlAtendidos = `
            <span class="label label-success pt-2 pb-2 font-16 font-weight-bold mytooltip mr-1 d-inline-block" title="Asignados">${serviciosAtendidos}
