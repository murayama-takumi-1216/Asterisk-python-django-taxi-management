    ...
    columns: [
      ...
      },
      {
        ...
        data: function (data) {
          ...
          let htmlCancelados = `
            <span class="label label-primary pt-2 pb-2 font-16 font-weight-bold mytooltip d-inline-block" title="Asignados">${serviciosCancelados}
          ...
          let htmlAtendidos = `
            <span class="label label-success pt-2 pb-2 font-16 font-weight-bold mytooltip d-inline-block mr-1" title="Asignados">${serviciosAtendidos}
